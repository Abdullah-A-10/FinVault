...
FinVault is a secure and modern Java-based Bank management system designed to simulate real-world financial operations with an intuitive user interface and strong focus on security.
## Overview
